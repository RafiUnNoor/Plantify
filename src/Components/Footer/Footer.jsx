        ...
        <footer id='footer' className='text-white' style={{ backgroundColor: '#123F1E' }}>
            <Container sx={{ py: isLargeScreen ? 6.8 : 5 }}>
                <div className='grid md:grid-cols-4 lg:grid-cols-5 sm:grid-cols-4 grid-cols-2 sm:gap-x-2 lg:gap-x-0 gap-x-1.5 sm:gap-y-9 lg:gap-y-0 gap-y-7 '>
                    ...
                    <div className='col sm:col-span-2  lg:col-span-2 xl:space-y-6 space-y-4'>
                        {/* Brand_Logo */}
                        <img className='xl:h-7 sm:h-6 h-5' src={Logo_light} alt="Plantify" />

                        {/* Description */}
                        <p className='sm:text-sm w-11/12 sm:w-10/12 text-xs tracking-wide'>
                            We provide fresh, environmentaly best indoor plants . Enjoy quick delivery and enjoy the best green and natural space's experience.
                        </p>
                        ...
                        <div className='flex md:space-x-3.5 space-x-3'>
                            ...
                            {/* Instagram */}
                            <a href="https://github.com/RafiUnNoor">
                            ...
                            {/* Linkedin */}
                            <a href="https://www.linkedin.com/in/md-rafi-un-noor-washik-811787107/">
                    ...
                    <div className='lg:col-auto md:col sm:col-span-3 col xl:space-y-3.5 space-y-2'>
                        ...
                        <div className='sm:space-y-2 space-y-1.5 xl:text-base text-sm'>
                            {/* Phone */}
                            <a className='block text-sm sm:text-base hover:underline' href="tel:+880 1780 962020">
                                <Phone fontSize='inherit' /> +880 1780 962020
                            </a>

                            {/* Email */}
                            <a className='block text-sm sm:text-base hover:underline' href="mailto:rafiun94@gmail.com">
                                <Mail fontSize='inherit' /> rafiun94@gmail.com
                            </a>

                            {/* Address */}
                            <address>
                                <LocationOn fontSize='inherit' /> 55/D , 9/A , Dhanmondi , Dhaka-1209 
                            </address>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className='text-center flex items-center h-12'>
                    <span className='text-xs  w-full block text-gray-300 tracking-wider'>© 2023 Developed By <a className='hover:underline' href="https://github.com/RafiUnNoor" target="_blank" rel="noopener noreferrer"> Rafi </a></span>
                </div>
            </div>
        </footer>
    );
