...
import Hero_bg from '../../../assets/backgrounds/bg_4.png';
import { Button, Container, useMediaQuery } from '@mui/material';
import hero_customer from '../../../assets/hero_graphics.png';
                    ...
                    <div className='col pt-3.5 flex items-center'>
                        <div className='xl:space-y-7 lg:space-y-6 md:space-y-4 sm:space-y-4 space-y-5 w-11/12 sm:tracking-normal tracking-wide'>
                            ...
                            <p className='lg:text-base md:text-sm sm:text-xs text-sm'>
                                Get the best quality and environment friendly indoor plants in Bangladesh, you can get them from our website. Indoor plants to decorate your precious spaces.
                            </p>
