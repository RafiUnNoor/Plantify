...
import gift from "../../../assets/categories/gift.png";
import pots from "../../../assets/categories/plant_pot.jpg";
import "swiper/css";
        ...
        <Swiper
            ...
            className="mySwiper">
            {
                [
                    ...
                    { id: 3, name: 'Gifts', img: gift, bgColor: '#eaf4f4' },
                    { id: 4, name: 'Various Pots', img: pots, bgColor: '#FAF9D7', }
                ].map(category => (
                    // Category_card 
